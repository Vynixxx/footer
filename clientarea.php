...
<body>
    ...
    <div class="container">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
        ...
        <div class="offcanvas-body">
          ...
          <div>
            <a class="btn" title="View cart" href="cart.php">
  ...
  <div class="card text-bg-primary mb-auto" style="max-width: 100%;">
    <div class="container"><br><br><br><br>
      <div class="card-header display-6 bg-primary">Start growing your business in this digital era<br>by choosing hosting at Lapak Hosting</div>
      <div class="card-body">
        <p class="card-text bg-primary">If your site is your personal business, we want you to be successful.<br> There are many website hosting options, <br>but the quality we provide is the best in the area.
          <br><br><br><br><br>
        </p>
      </div>
    </div>
  ...
  <div class="container mt-5 pt-5">
    <div class="row row-cols-1 row-cols-md-3 g-4 mt-5 pb-5 mb-5">
      <div class="col">
        <div class="card">
          <a title="Pick Domain" href="domain.php"><center><svg xmlns="http://www.w3.org/2000/svg" width="13%" height="50%" fill="currentColor" class="bi bi-globe my-3" viewBox="0 0 16 16">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Register your domain right now here.</p>
          </div>
        </div>
        </center>
      </div>
      <div class="col">
        <div class="card">
          <a title="Pick Hosting" href="hosting.php"><center><svg xmlns="http://www.w3.org/2000/svg" width="13%" height="50%" fill="currentColor" class="bi bi-server my-3" viewBox="0 0 16 16">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Choose the right hosting package for your site.</p>
          </div>
        </div>
        </center>
      </div>
      <div class="col">
        <div class="card">
          <a title="Contact Admin" href="https://m.me/Phoenix"><center><svg xmlns="http://www.w3.org/2000/svg" width="13%" height="50%" fill="currentColor" class="bi bi-headset my-3" viewBox="0 0 16 16">
            <path d="M8 1a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a6 6 0 1 1 12 0v6a2.5 2.5 0 0 1-2.5 2.5H9.366a1 1 0 0 1-.866.5h-1a1 1 0 1 1 0-2h1a1 1 0 0 1 .866.5H11.5A1.5 1.5 0 0 0 13 12h-1a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h1V6a5 5 0 0 0-5-5z"/>
          </svg></center></a>
          <center>
          <div class="card-body">
            <h5 class="card-title">Admin Availability 24/7</h5>
            <p class="card-text">We're always online 24 hours to help you</p>
          </div>
        </div>
        </center>
      </div>
  ...
  <section class="card text-bg-primary mb-auto">
    <div class="container mt-5 pt-5">
